...
public class Step2_문자열비교 {//class start
    ...
    public static void main(String[] args) {//main start
        ...
        // 2. 문자열 비교
            // 1. ==
        String name1 = "홍길동";       // 힙영역???       " " 리터럴 의미가 문자열객체에 생성
        String name2 = "홍길동";
        ...
        Scanner scanner = new Scanner(System.in);
            String inpitName = scanner.next();  // 새로운 문자열 반환.

        System.out.println(name1 ==inpitName);
        System.out.println(name1.equals(inpitName));

            // 5. null(객체없다)    vs "" vs ""
        String hobby2 = "";
        if(hobby2.equals("")){
            System.out.println("honny변수가 참조하는 String 객체는 빈 문자열");
        }
        String hobby3 = null;
        if(hobby3 != null && hobby3.equals("")){
            System.out.println("문자열객체가 존재하면서 문자열 비교");
        }else {
            System.out.println("else = "+hobby3);
        }
