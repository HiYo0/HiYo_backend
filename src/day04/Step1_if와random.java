...
public class Step1_if와random {//class start
    public static void main(String[] args) { // main start
        ...
        if( score >= 90 ) { // if s
            System.out.println("저수가 90보다 큽니다.");
        ...
        int num = (int) (Math.random()*6+1);    // (int) 0.xx ~ 1.xx * 6 + 1 =>  1 ~ 7 미만

        // 2.
        Random random = new Random();
        // 클래스명 변수명 = new 클래스명();   // 클래스에 해당하는 객체 생성 ( 객체를 만드는 이유 : 라이브러리 (미리 만들
        // int num2 = random.nextInt();     // int 허용범위내 난수 생성 +-21억정도 중 난수
        // int num2 = random.nextInt(6);   // 0 ~ 6 미만
        int num2 = random.nextInt(6)+1; // 0 ~ 6 미만 + 1 => 1 ~ 7미만 => 1~6

        if( num2 == 1 ){ System.out.println("주사위는 1 입니다."); }
        else if( num2 == 2 ){ System.out.println("주사위는 2 입니다."); }
        else if( num2 == 3 ){ System.out.println("주사위는 3 입니다."); }
        else if( num2 == 4 ){ System.out.println("주사위는 4 입니다."); }
        else if( num2 == 5 ){ System.out.println("주사위는 5 입니다."); }
        else{ System.out.println("주사위는 6 입니다."); }
